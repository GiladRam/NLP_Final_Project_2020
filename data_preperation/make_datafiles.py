...
all_train_urls = "./url_lists/all_train_small.txt"
all_val_urls = "./url_lists/all_val_small.txt"
all_test_urls = "./url_lists/all_test_small.txt"
...
if __name__ == '__main__':
    ...
    write_to_bin("./url_lists/all_test_small.txt", os.path.join(finished_files_dir, "test.bin"))
